...
class ArchitecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create architecture" do
    assert_difference('Architecture.count') do
      post architectures_url, params: { architecture: { description: @architecture.description, diagram: @architecture.diagram, form_id: @architecture.form_id } }
    end
  ...
  test "should update architecture" do
    patch architecture_url(@architecture), params: { architecture: { description: @architecture.description, diagram: @architecture.diagram, form_id: @architecture.form_id } }
