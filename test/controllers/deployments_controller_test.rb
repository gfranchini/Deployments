...
class DeploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deployment" do
    assert_difference('Deployment.count') do
      post deployments_url, params: { deployment: { form_id: @deployment.form_id, installation: @deployment.installation, repo: @deployment.repo, software: @deployment.software, stack: @deployment.stack } }
    end
  ...
  test "should update deployment" do
    patch deployment_url(@deployment), params: { deployment: { form_id: @deployment.form_id, installation: @deployment.installation, repo: @deployment.repo, software: @deployment.software, stack: @deployment.stack } }
